...
SELECT
  ...
  CONCAT(
    ...
    ELT(FLOOR((n - 1) / 12) + 1, '은혜', '믿음', '요셉', '마리아', '요한', '사랑', '기쁨', '평안')
  ),
  ...
  '한영교회 공동체와 함께 믿음의 길을 걸었습니다.',
  'auto',
  '가족과 교회 공동체가 함께 기억하기 위해 준비된 샘플 추모관입니다. 고인의 삶과 신앙은 예배와 섬김의 자리에서 조용히 이어졌고, 남겨진 마음 속에 감사와 믿음으로 기억됩니다.',
  'auto',
  NULL,
  NULL,
  'public',
