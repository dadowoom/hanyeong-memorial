...
export const historyDecades = mysqlTable(
  "history_decades",
  {
    id: int("id").autoincrement().primaryKey(),
  ...
  table => [
    index("history_decades_visible_sort_idx").on(
      table.isVisible,
      table.sortOrder,
      table.startYear
    ),
...
export const historyItems = mysqlTable(
  "history_items",
  {
    id: int("id").autoincrement().primaryKey(),
    decadeId: int("decade_id")
      .notNull()
      .references(() => historyDecades.id, { onDelete: "cascade" }),
  ...
  table => [
    index("history_items_decade_visible_sort_idx").on(
      table.decadeId,
      table.isVisible,
      table.sortOrder,
      table.year,
