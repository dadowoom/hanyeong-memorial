...
export const navItems = [
  { label: "교회 연혁", href: routes.history },
...
export const serviceLinks = [
  { label: "교회 연혁", href: routes.history, type: "route" },
  ...
  values: [
    {
      number: "01",
      title: "교회가 걸어온 길",
      desc: "1961년 기도 모임에서 시작해 오늘에 이르기까지 예배와 선교, 교육과 섬김으로 이어온 한영교회의 역사를 기록합니다.",
    },
    {
      number: "02",
      title: "성도가 남긴 믿음",
      desc: "한 사람의 예배와 봉사, 기도와 헌신을 신앙기념관에 담아 교회의 역사 안에서 함께 기억합니다.",
    },
    {
      number: "03",
      title: "다음 세대의 유산",
      desc: "교회와 성도의 기록을 다음 세대가 만나고, 말로 다 전하지 못한 믿음의 이야기를 이어받도록 보존합니다.",
    },
  ],
} as const;
